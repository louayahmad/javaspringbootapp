package com.app.reminder.components;
...
import com.app.reminder.services.SendEmail;
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            if (email != null && showName != null) {
                sendEmail.sendReminderEmail(email, "TV Show Reminder", "Your show " + showName + " is starting soon!");
